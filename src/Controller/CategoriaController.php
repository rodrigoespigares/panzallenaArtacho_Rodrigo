...
class CategoriaController extends AbstractController
{
    ...
    #[Route('/{codCat}', name: 'app_categoria_show', methods: ['GET'])]
    ...
    #[Route('/{codCat}/edit', name: 'app_categoria_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{codCat}', name: 'app_categoria_delete', methods: ['POST'])]
